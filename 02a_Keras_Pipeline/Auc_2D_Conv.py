...
valid_dataset = pic[p][:5000]
valid_labels = lab[p][:5000]
test_dataset = pic[p][5000:20000]
test_labels = lab[p][5000:20000]
train_dataset = pic[p][20000:]
train_labels = lab[p][20000:]
del p, pic, lab
            ...
            for patch_size in [3]:
                for depth in [16]:
                    for num_hidden in [128]:
                        ...
                        LOGDIR = '/home/jbehnken/tensorflowlogs_2' # Path to logfiles
                        ...
                        with tf.name_scope('auc'):
                            auc = tf.contrib.metrics.streaming_auc(tf_valid_labels, valid_prediction)
